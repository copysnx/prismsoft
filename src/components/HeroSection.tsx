        ...
        <div className="max-w-2xl">
          ...
          <div className="mb-6 flex items-center gap-2 animate-fade-in">
            <div className="flex gap-0.5">
              {[...Array(5)].map((_, i) => (
                <svg key={i} className="h-5 w-5 fill-purple-500" viewBox="0 0 20 20">
          ...
          <h1 className="mb-6 text-4xl font-black tracking-tight sm:text-5xl md:text-6xl animate-slide-up">
            Bem Vindo(a)
            <br />
            <span className="text-gradient glow-text">NexTSysteM</span>!
          </h1>

          {/* Description */}
          <p className="mb-8 text-lg text-muted-foreground leading-relaxed animate-slide-up" style={{ animationDelay: "0.1s" }}>
